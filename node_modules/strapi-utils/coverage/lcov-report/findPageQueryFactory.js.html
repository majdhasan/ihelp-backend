...
<head>
    <title>Code coverage report for findPageQueryFactory.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> findPageQueryFactory.js</h1>
        <div class='clearfix'>
...
function withDefaultPagination(params) {
  const { page = DEFAULT_PAGINATION_OPTS.page, pageSize = DEFAULT_PAGINATION_OPTS.pageSize, ...rest } = params;
&nbsp;
  return {
    page: parseInt(page),
    pageSize: parseInt(pageSize),
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon May 18 2020 17:10:04 GMT+0200 (Central European Summer Time)
            </div>
        </div>
